...
const DCO_Name = import.meta.env.VITE_DCO_NAME;
const DC_Email = import.meta.env.VITE_DCO_EMAIL;
...
const PCO_Name = import.meta.env.VITE_PCO_NAME;
const PCO_Email = import.meta.env.VITE_PCO_EMAIL;
    ...
    return(
        <div className='termPrivacy_mainContainer'>
            ...
            <div className='termPrivacy_section'>
                ...
                <address className="alt">
                    <a href={`mailto:${Owner_Email}?subject=Regarding%20Privacy%20Policy...`}>{Owner_Email}</a>
            ...
            <div className='termPrivacy_section'>
                ...
                <div className="content">
                    ...
                    <p>If you would like to know if we have collected your personal data, how we have used your personal data, if we have disclosed your personal data and to who we disclosed your personal data, or if you would like your data to be deleted or modified in any way, please contact our privacy officer here:</p>
                    <address className='alt'>
                        <p>{PCO_Name}</p>
                        <a href={`mailto:${PCO_Email}?subject=Regarding%20Privacy%20Policy...`}>{PCO_Email}</a>
                        <a href={PCO_PhoneLink}>{PCO_PhoneDisplay}</a>
                        <p>{PCO_AddressLine1}</p>
                        <p>{PCO_AddressLine2}</p>
                        <p>{PCO_AddressLine3}</p>
                ...
                <div className="content">
                    ...
                    <ol>
                        <li>You can opt-out of the use of SMS Text and/or emails. You can opt-out by clicking "unsubscribe" link at the bottom of any emails. You can opt-out by clicking "unsubscribe" link at the bottom of any emails and text messages.</li>
                    </ol>
                </div>
                <div className="content">
                    <h3>Cookie Policy</h3>
                ...
                <div className="content">
                    ...
                    <p>If you have any questions, concerns or complaints, you can contact our privacy officer, {PCO_Name}, at:</p>
                    <address className='alt'>
                        <p>{PCO_Name}</p>
                        <a href={`mailto:${PCO_Email}?subject=Regarding%20Privacy%20Policy...`}>{PCO_Email}</a>
                        <a href={PCO_PhoneLink}>{PCO_PhoneDisplay}</a>
